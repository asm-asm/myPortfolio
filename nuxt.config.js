  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', property: 'og:url', content: 'https://asm-design.work/' },
      ...
      { hid: 'og:image', property: 'og:image', content: 'https://asm-design.work/img/ogp.png' },
    ],
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      { rel: 'apple-touch-icon', sizes: '180x180', href: '/img/apple-touch-icon.png' },
      { rel: 'icon', sizes: '32x32', href: '/img/icon-32x32.png' },
      { rel: 'icon', sizes: '16x16', href: '/img/icon-16x16.png' },
